    ...
    for furmult in 0:1
        ...
        @testset "endotherm mass flux comparisons" begin
            if metabolic_rate_options.respire
                ...
                @test masbal_output_vec.O2_mol_out ≈ ustrip(u"mol/hr", mass_fluxes.molar_fluxes_out.oxygen) rtol = rtol
                ...
                @test masbal_output_vec.N2_mol_in ≈ ustrip(u"mol/hr", mass_fluxes.molar_fluxes_in.nitrogen) rtol = rtol
                @test masbal_output_vec.N2_mol_out ≈ ustrip(u"mol/hr", mass_fluxes.molar_fluxes_out.nitrogen) rtol = rtol
                @test masbal_output_vec.AIR_mol_in ≈ ustrip(u"mol/hr", mass_fluxes.molar_fluxes_in.air) rtol = rtol
                @test masbal_output_vec.AIR_mol_out ≈ ustrip(u"mol/hr", mass_fluxes.molar_fluxes_out.air) rtol = rtol
            end
        end
    end
end