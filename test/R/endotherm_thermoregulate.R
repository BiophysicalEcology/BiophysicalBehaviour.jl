...
endoR_input = list(
  ...
  ZFURD = furmult*13.9E-03, # fur depth, dorsal (m)
  ...
  AK1 = 0.412, # initial thermal conductivity of flesh (0.412 - 2.8 W/m°C)
  ...
  PZFUR = 0.1, # # incremental fractional reduction in ZFUR from piloerect state (-) (a value greater than zero triggers piloerection response)
