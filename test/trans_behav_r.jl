...
core_temperature_init = u"K"(22.8078239301283u"°C")  # R's trans_behav.R day_results$Tb[1] (t=0)
...
# To plot the Julia trajectory against R's own per-timestep output, rerun
# test/R/trans_behav.R to regenerate trans_behav_day_results.csv (not checked in -
# 8600+ rows), then:
